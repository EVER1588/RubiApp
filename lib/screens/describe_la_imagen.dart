...
import '../categorias/familia_screen.dart';
...
class _Metodo3ScreenState extends State<Metodo3Screen> {
  ...
  void _navegarACategoria(String categoria) {
    ...
    if (categoria == "Animales") {
      ...
      _familia ??= FamiliaScreen();
      screen = _familia;
    }

    if (screen != null) {
      MusicManager.instance.playForScreen(MusicManager.trackDescribe);
      Navigator.push(context, MaterialPageRoute(builder: (context) => screen!))
          .then((_) => MusicManager.instance.playForScreen(MusicManager.trackHome));
    }
  }
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text('📐 Tamaño de items', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.white)),
                                ],
                              ),
                              SizedBox(height: 10), 
                              isDialogLandscape
  ...
  Widget build(BuildContext context) {
    ...
    final columns = isLandscape ? _getLandscapeColumns() : _getPortraitColumns(context);
